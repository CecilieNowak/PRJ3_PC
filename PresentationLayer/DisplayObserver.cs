...
namespace PresentationLayer
{
    class DisplayObserver : IBloodPressureObserver
    {
        ...
        {
           DTO_UDP subject = _bp.getNewestDTO();              //Her hentes den nyeste DTO som er tilføjet til subjectet og gemmes i en ny variable 
           mw.YValues.Add(Convert.ToInt32(subject.Værdi));
           mw.XValues.Add(1);
